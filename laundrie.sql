...
--
-- Host: localhost:3306
-- Generation Time: Nov 29, 2018 at 12:49 PM
...
(7, 'Romadhan', '111111', 'romadhanedy@outlook.com', 'Admin');
...
--
ALTER TABLE `order`
  ADD CONSTRAINT `order_ibfk_1` FOREIGN KEY (`paket_id`) REFERENCES `paket` (`id`),
